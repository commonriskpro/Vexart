...
import { solidJsxPlugin } from "./solid-plugin"
...
function starterFiles(name: string): Record<string, string> {
  return {
    ...
    "app/page.tsx": [
      "import { Box, Text, useRouter } from \"vexart\"",
      "",
    ...
    "app/projects/[id]/page.tsx": [
      "import { Box, Text, type RouteParams, useRouter } from \"vexart\"",
      "",
...
async function writeGeneratedDevEntry(root = process.cwd()) {
  ...
  await Bun.write(entry, [
    ...
    "import { createAppRouter, mountApp, RouteOutlet, RouterProvider } from \"vexart\"",
