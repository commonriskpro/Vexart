...
export type GridAvailableSpace = {
    ...
    readonly constraint: "min-content" | "max-content";
};
...
export type GridIntrinsicMeasureFunc = (axis: GridAxis, availableInlineWidth: number | undefined) => GridIntrinsicSizes;
/**
...
export declare function createGridScratch(): GridScratch;
export declare function resetGridScratch(scratch: GridScratch): void;
export declare function createEmptyExpandedTracks(axis: GridAxis, explicitCount?: number): ExpandedTracks;
export declare function createExpandedTracks(axis: GridAxis, tracks: readonly GridTrackState[], explicitCount: number): ExpandedTracks;
export declare function createEmptyResolvedLines(axis: GridAxis, explicitCount?: number): ResolvedLines;
export declare function createResolvedLines(axis: GridAxis, positions: readonly number[], names: ReadonlyMap<string, readonly number[]>, explicitCount: number): ResolvedLines;
export declare function createEmptyPlacementResult(rowCount?: number, columnCount?: number): PlacementResult;
export declare function createExpandedAxes(columns: ExpandedTracks, rows: ExpandedTracks): GridExpandedAxes;
export declare function createResolvedLineSet(columns: ResolvedLines, rows: ResolvedLines): GridResolvedLineSet;
