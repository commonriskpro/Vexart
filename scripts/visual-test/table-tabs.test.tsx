...
import type { TabItem, TabRenderContext } from "../../packages/headless/src/containers/tabs"
...
// Register it before dynamically importing the Solid universal components.
if (browserRuntime) await import("../../solid-plugin")
const { Tabs } = await import("../../packages/headless/src/containers/tabs")
...
suite("Styled table reached through tabs", () => {
