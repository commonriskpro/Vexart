...
### A.6 `vxrt` (dist barrel)

The published npm package `vxrt` bundles all internal packages into two entry
...
import must also be in the barrel. Forced mixed imports (`vxrt` + `vxrt/engine`)
