# Vexart — Detailed Agent Reference

Load this reference when a task touches visual effects, interaction contracts,
complete props or exports, styled/app APIs, package layout, or the external
technical links below. The reference preserves the project's detailed runtime
and API knowledge while the root instructions stay focused on always-needed
constraints.
