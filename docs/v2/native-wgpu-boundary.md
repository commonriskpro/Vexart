...
- `vexart_image_asset_touch(ctx: u64, scene: u64, handle: u64, frame: u64) -> i32`: Updates LRU priority for image asset.
- `vexart_image_asset_release(ctx: u64, scene: u64, handle: u64) -> i32`: Releases image asset.
- `vexart_canvas_display_list_update(ctx: u64, scene: u64, handle: u64, key_ptr: *const u8, key_len: u32, ops_ptr: *const u8, ops_len: u32, stats_out: *mut u32) -> i32`: Updates canvas display list.
- `vexart_canvas_display_list_touch(ctx: u64, scene: u64, handle: u64, frame: u64) -> i32`: Updates LRU priority for canvas.
- `vexart_canvas_display_list_release(ctx: u64, scene: u64, handle: u64) -> i32`: Releases canvas display list.
