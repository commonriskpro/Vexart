...
The benchmark runner MUST report frame stage timings for scroll/input, layout, relayout, interaction, layer assignment, native snapshot, layer prep, frame context, backend begin/paint/end, render graph, presentation, cleanup, terminal sync, I/O, paint, and total frame time.
