...
- [x] 3.4 Gate native render graph snapshots to dirty frames and route hover-only interaction frames through the cheaper TS compatibility hit-test until native event dispatch is optimized.
